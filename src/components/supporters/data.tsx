...
const data = {
	...
	images3: [
		...
		},
		{
			...
			more: '(Tainá mudar) raduada em Publicidade e Propaganda pela Universidade (2004-2007), atuou por 15 anos na área de Marketing do Banco Paulista S.A.',
			linkedin: '',
		},
	],
};
